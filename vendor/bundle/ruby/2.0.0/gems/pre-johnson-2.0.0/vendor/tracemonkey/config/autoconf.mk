...
ac_configure_args =  --enable-static
...
MOZ_DEBUG_MODULES = 
MOZ_PROFILE_MODULES = 
MOZ_DEBUG_ENABLE_DEFS		= -DDEBUG -D_DEBUG -DDEBUG_lyatesco -DTRACING
...
MOZ_BUILD_ROOT             = /home/lyatesco/ldfees32/vendor/bundle/ruby/2.0.0/gems/pre-johnson-2.0.0/vendor/tracemonkey
...
OS_CXXFLAGS	= $(OS_CPPFLAGS) -fno-rtti -fno-exceptions -Wall -Wpointer-arith -Woverloaded-virtual -Wsynth -Wno-ctor-dtor-privacy -Wno-non-virtual-dtor -Wcast-align -Wno-invalid-offsetof -Wno-variadic-macros -Wno-long-long -pedantic -fno-strict-aliasing -pthread -pipe
OS_LDFLAGS	= -lpthread 
...
CC_VERSION	= gcc version 4.1.2 20080704 (Red Hat 4.1.2-55)
CXX_VERSION	= gcc version 4.1.2 20080704 (Red Hat 4.1.2-55)
...
OS_TARGET=Linux
OS_ARCH=Linux
OS_RELEASE=3.14.25-grsec.3.el5
OS_TEST=x86_64
